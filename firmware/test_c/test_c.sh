...
# Override SBE_LLVM_INSTALL_DIR for a non-default toolchain location.
TOOLCHAIN_DIR="${SBE_LLVM_INSTALL_DIR:-/opt/llvm-install}"
CLANG="${TOOLCHAIN_DIR}/bin/clang"
LLC="${TOOLCHAIN_DIR}/bin/llc"
LLVM_AS="${TOOLCHAIN_DIR}/bin/llvm-as"
OPT="${TOOLCHAIN_DIR}/bin/opt"
LLVM_DIS="${TOOLCHAIN_DIR}/bin/llvm-dis"
POWERPC_AS="${TOOLCHAIN_DIR}/bin/llvm-mc"
POWERPC_LD="${TOOLCHAIN_DIR}/bin/ld.lld"
POWERPC_OBJDUMP="${TOOLCHAIN_DIR}/bin/llvm-objdump"
